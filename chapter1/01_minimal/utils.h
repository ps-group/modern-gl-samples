...
using AttributeBindingMap = std::vector<std::pair<AttributeId, std::string_view>>;
...
gl::GLuint LinkProgram(gl::GLuint vs, gl::GLuint fs, const AttributeBindingMap& binding);
